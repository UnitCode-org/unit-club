...
function Navbar({ hideLinks }: NavbarProps) {
  ...
  return (
    <>
      ...
      {/* Desktop Navbar */}
      <div className={"hidden md:flex flex-row gap-4 items-center justify-between w-full max-w-screen-2xl py-8 px-10 top-0" + (!isFixed ? " sticky z-10" : " fixed left-0 z-50")}>
        {!hideLinks && (
