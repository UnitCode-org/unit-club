...
function Navbar({ hideLinks }: NavbarProps) {
  ...
  return (
    <>
      {/* Mobile Navbar */}
      <div
        className={`flex md:hidden flex-row gap-4 items-center justify-between w-full p-6 ${
      ...
      {/* Desktop Navbar */}
      <div
        className={`hidden md:flex flex-row gap-4 items-center justify-between w-full py-8 px-10 ${
          isFixed && "fixed top-0 left-0 w-full z-50"
        }`}
      >
        {!hideLinks && (
