    ...
    <div className="text-center flex flex-col flex-grow justify-center mb-20 gap-8">
      <AnimatePresence>
        {firstIntro && (
          <>
            <FadeIn>
              <h3 className="font-medium text-unit-gray-30 text-lg">
                WELCOME TO THE
              </h3>
            </FadeIn>
            <FadeIn delay={0.5}>
              <h1 className="font-bold text-9xl font-albert-sans text-unit-gray-20">
                UNIT CLUB
              </h1>
            </FadeIn>
            <FadeIn delay={1}>
              <h2 className="font-medium text-unit-gray-30 text-lg">
                BY UNIT NETWORK
              </h2>
            </FadeIn>
          </>
        ...
        {secondIntro && (
          <>
            <FadeIn>
              <h1 className="font-medium text-unit-gray-30 text-lg">
